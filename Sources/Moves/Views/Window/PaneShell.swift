...
///
/// Now renders a pane title row (title + count badge + accessory slot) at
...
/// hierarchy beat.
struct PaneShell<Content: View, Accessory: View, Inspector: View>: View {
  let title: String
  let count: Int?
...
extension PaneShell where Accessory == EmptyView, Inspector == EmptyView {
  init(
    title: String,
    count: Int? = nil,
...
extension PaneShell where Inspector == EmptyView {
  init(
    title: String,
    count: Int? = nil,
...
/// it and (optionally) the inspector rail to its trailing edge.
struct PaneListShell<Content: View, Accessory: View, Inspector: View>: View {
  let title: String
  let count: Int?
  @ViewBuilder var accessory: () -> Accessory
  @ViewBuilder var content: () -> Content
...
extension PaneListShell where Accessory == EmptyView, Inspector == EmptyView {
  init(
    title: String,
    count: Int? = nil,
    @ViewBuilder content: @escaping () -> Content
...
extension PaneListShell where Inspector == EmptyView {
  init(
    title: String,
    count: Int? = nil,
    @ViewBuilder accessory: @escaping () -> Accessory,
